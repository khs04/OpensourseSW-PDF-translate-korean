...
def convert_to_images(input_file):
    poppler_path = r"C:\Users\hureu\Downloads\poppler-24.08.0\Library\bin" #poppler다운후 경로지정
...
def ocr_entire_pdf(pdf_path):
    poppler_path = r"C:\Users\hureu\Downloads\poppler-24.08.0\Library\bin"
    pytesseract.pytesseract.tesseract_cmd = r"C:\Program Files\Tesseract-OCR\tesseract.exe"
...
# Find the PDF path
pdf_path = r"C:\Users\hureu\MLP\argos-translate\test_eng_treatise.pdf"
